...
export default function Home () {
    ...
    return(
        ...
        <div className='Content'>
          <span style={{color: "#1F6F78", fontSize: "50px"}}>Hier entsteht eine neue Webseite!</span>
          </div>
                ...
                <ul>
                    <li>
                        <Popup trigger={<img src={contact} alt="contact" style={{ height: "30px", cursor: "pointer" }} />} position="left center">
                            <div>ha-consult <br></br> Bahnhofstr. 40, 94032 Passau <br></br> <a href="tel:085137934170">0851 - 379 341 70</a> <br></br> <a href="mailto:office@ha-consult.de">office@ha-consult.de</a></div>
                        </Popup>
                    </li>
                </ul>
            </nav>
